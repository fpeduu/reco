...
interface TenantModalProps {
  ...
  debtor: Devedor | null;
  onClose: () => void;
  onConfirm: (debtor: Devedor, negotiation: INegotiationData) => Promise<boolean>;
}
...
export default function TenantModal({ open, debtor, onClose, onConfirm }: TenantModalProps) {
