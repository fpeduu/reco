  ...
  return (
    <div className="containerLayout flex flex-col gap-10">
      ...
      <div className="w-full h-fit bg-white rounded-2xl">
        <nav className="h-10 border-b border-b-slate-300 relative">
          <button
            onClick={switchToTimeline}
            className={
              "w-56 h-10 p-5 pb-0 absolute border-b text-sm " +
              (subpage === "timeline"
          ...
          <button
            ...
            className={
              "w-56 h-10 p-5 pb-0 absolute left-56 border-b text-sm " +
              (subpage === "details"
                ? "text-red-600 border-b-red-600"
                : "text-slate-500 border-b-slate-300")
            }>
