...
export default function FeatureCard({ image, title, description }: FeatureCardProps) {
  return (
    <div className="md:w-128 2xl:w-160 h-80 p-6 z-10 flex items-center flex-wrap md:flex-nowrap justify-center gap-5 bg-neutral-950 rounded-2xl shadow-md  md:divide-x text-neutral-200 md:min-w-[500px] min-h-[150px] md:h-[150px] md:justify-start">
