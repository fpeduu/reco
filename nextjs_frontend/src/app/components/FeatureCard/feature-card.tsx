...
export default function FeatureCard({ image, title, description }: FeatureCardProps) {
  return (
    <div className="w-96 p-6 z-10 flex items-center justify-center gap-5 bg-neutral-950 rounded-2xl shadow-md divide-x text-neutral-200 md:min-w-[500px] min-h-[150px] md:h-[150px] md:justify-start">
